...
class Sine_Customizer_Loader extends Sine_Helper{
	...
	public function __construct(){
		...
		require self::get_theme_path( $path . 'repeater/repeater.php'					);
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'sineColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
