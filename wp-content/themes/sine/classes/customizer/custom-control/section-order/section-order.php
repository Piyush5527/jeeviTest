...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Sine_Section_Order extends WP_Customize_Control {
		 ...
		 * @package Sine Theme
		 */
		public $type = 'sine-section-order';
		...
		protected function content_template() {
			?>
			<div class="sine-section-order">
				<span class="customize-control-title">{{{ data.label }}}</span>
				<span class="description customize-control-description">{{{ data.description }}}</span>
				<# if( '' != data.sections ){ #>
				<ul class="sine-sortable-section {{data.id}}">
				...
				<# }else{ #>
					<li><?php esc_html_e( 'No section enabled. Please enable sections', 'sine' ); ?></li>
				<# } #>
...
Sine_Customizer::add_custom_control( array(
    ...
    'class'    => 'Sine_Section_Order',
    'sanitize' =>  array( 'Sine_Section_Order', 'sanitize' )
));