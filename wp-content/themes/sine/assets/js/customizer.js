...
wp.customize.controlConstructor['sine-buttonset'] = wp.customize.Control.extend({
  ...
  jQuery(document).ready(function ($) {
    ...
    $('.alpha-color-control').each(function () {
      ...
      colorPickerOptions = {
        ...
        palettes: sineColorPalette.colorPalettes // Use the passed in palette.
      ...
      $('<div class="alpha-sine-color-picker-container">' + '<div class="min-click-zone click-zone"></div>' + '<div class="max-click-zone click-zone"></div>' + '<div class="alpha-slider"></div>' + '<div class="transparency"></div>' + '</div>').appendTo($container.find('.wp-picker-holder'));
...
wp.customize.controlConstructor['sine-dimensions'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';
...
jQuery(document).ready(function ($) {
  ...
  $('.linked').on('click', function () {
    ...
    $this.parent('.link-sine-dimensions').removeClass('unlinked');
  }); // Unlinked button
  ...
  $('.unlinked').on('click', function () {
    ...
    $this.parent('.link-sine-dimensions').addClass('unlinked');
...
wp.customize.controlConstructor['sine-icon'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';
...
jQuery(window).load(function () {
  ...
  jQuery('.customize-control-sine-radio-image .buttonset').buttonset(); // Handles setting the new value in the customizer.

  jQuery('.customize-control-sine-radio-image input:radio').change(function () {
...
wp.customize.controlConstructor['sine-range'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';
    ...
    var control = this,
        ...
        input_default,
        changeAction,
        sine_range_input_number_timeout; // Update the text value
    ...
    function autocorrect_range_input_number(input_number, timeout) {
      ...
      clearTimeout(sine_range_input_number_timeout);
      sine_range_input_number_timeout = setTimeout(function () {
        if (isNaN(value)) {
...
/***/ "./classes/customizer/custom-control/repeater/assets/repeater.js":
/*!***********************************************************************!*\
  !*** ./classes/customizer/custom-control/repeater/assets/repeater.js ***!
  \***********************************************************************/
/*! no static exports found */
...
wp.customize.controlConstructor['sine-repeater'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';
    ...
    var getIndexText = function getIndexText() {
...
wp.customize.controlConstructor['sine-section-order'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';

    var control = this;
    jQuery('#customize-control-' + control.params.id).find('.sine-sortable-section').sortable({
...
wp.customize.controlConstructor['sine-slider'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';
...
(function ($, api) {
  api.controlConstructor['sine-toggle'] = api.Control.extend({
    ready: function ready() {
      var control = this;
...
__webpack_require__(/*! ../../classes/customizer/custom-control/repeater/assets/repeater.js */ "./classes/customizer/custom-control/repeater/assets/repeater.js");
