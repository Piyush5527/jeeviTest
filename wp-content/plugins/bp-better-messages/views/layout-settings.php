...
<div class="wrap">
    ...
    <div class="nav-tab-wrapper" id="bpbm-tabs">
        ...
        <a class="nav-tab" id="chat-tab" href="#messaging"><?php _e( 'Messaging', 'bp-better-messages' ); ?></a>
    ...
    <form action="" method="POST">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top" class="">
                            ...
                            <td>
                                ...
                                <p><?php echo sprintf(__('If first shortcode does not work (this can happen when using some page builders) - use <code>%s</code> shortcode instead.', 'bp-better-messages'), '[better_messages]'); ?></p>
                            </td>
                        </tr>
                        <tr>
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">
                        ...
                        <p style="font-size: 10px;"><?php _e( 'Settings related to starting new conversations by website members', 'Settings page', 'bp-better-messages' ); ?></p>
                    </th>
                    <td>
                        <fieldset>
                ...
                <tr>
                    <th scope="row">
                        ...
                        <p style="font-size: 10px;"><?php _e( 'Settings related to searching users while starting the conversation', 'Settings page', 'bp-better-messages' ); ?></p>
                    </th>
                                ...
                                <tbody>
                                    ...
                                    <tr valign="top" class="">
                                        ...
                                        <th>
                                            ...
                                            <p style="font-size: 10px;"><?php _ex( 'Enable search among all users when starting new thread', 'Settings page', 'bp-better-messages' ); ?></p>
                        ...
                        <fieldset>
                            <table class="widefat bm-switcher-table">
                                ...
                                <tr valign="top" class="">
                                    ...
                                    <th>
                                        <?php _ex( 'Messages Status in Conversations List', 'Settings page', 'bp-better-messages' ); ?>
                                ...
                                <tr valign="top" class="">
                                    ...
                                    <th>
                                        <?php _e( 'Enable link previews', 'bp-better-messages' ); ?>
                        ...
                        <fieldset>
                            <table class="widefat bm-switcher-table">
                                ...
                                <tr valign="top" class="">
                                    ...
                                    <th>
                                        <?php _ex( 'Allow users to leave threads with multiple participants', 'Settings page', 'bp-better-messages' ); ?>
                                        <p style="font-size: 10px;"><?php _ex( 'Allow users to leave threads with multiple participants (creator can`t leave thread he started)', 'Settings page', 'bp-better-messages' ); ?></p>
                                    </th>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <table class="widefat bm-switcher-table">
                                    ...
                                    <tr valign="top" class="">
                                        ...
                                        <th>
                                            ...
                                            <p style="font-size: 10px;"><?php _ex( 'Enables mini conversations list widget fixed to the bottom of browser window', 'Settings page', 'bp-better-messages' ); ?></p>
                                        </th>
                                    </tr>
                                    <tr valign="top" class="">
                                        <td>
        ...
        <div id="notifications" class="bpbm-tab">
            <table class="form-table">
                ...
                <tr valign="top" class="">
                    <th scope="row" valign="top">
                        <?php _ex( 'Title notifications', 'Settings page', 'bp-better-messages' ); ?>
                        <p style="font-size: 10px;"><?php _ex( 'Show unread threads number in website title (browser tab)', 'Settings page', 'bp-better-messages' ); ?></p>
                    </th>
                    <td>
                ...
                <tr valign="top" class="">
                    <th scope="row" valign="top">
                        <?php _ex( 'Mute Threads', 'Settings page', 'bp-better-messages' ); ?>
                        <p style="font-size: 10px;"><?php _ex( 'When enabled users will be able to mute threads', 'Settings page', 'bp-better-messages' ); ?></p>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row" style="width: 300px">
                        <?php _e( 'Onsite notifications position', 'bp-better-messages' ); ?>
                    </th>
                    <td>
                        <fieldset>
                            <fieldset>
                    ...
                    <td>
                        <fieldset>
                            <table class="widefat bm-switcher-table">
                                ...
                                <tr valign="top" class="">
                                    <th scope="row" valign="top" class="th-left-pd">
                                        <?php _ex( 'Side Threads Width', 'Settings page', 'bp-better-messages' ); ?>
                                        <p style="font-size: 10px;"><?php _ex( 'Side Threads Width when Combined View is enabled in pixels', 'Settings page', 'bp-better-messages' ); ?></p>
                                    </th>
                                    <td>
        ...
        <div id="integrations" class="bpbm-tab">
            <div class="nav-tab-wrapper bpbm-sub-tabs">
                ...
                <a class="nav-tab" id="emojies-tab" href="#bm-emojies"><?php _ex( 'Emojis', 'Settings page','bp-better-messages' ); ?></a>
            </div>
                            ...
                            <fieldset>
                                <table class="widefat bm-switcher-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <?php _ex( 'Enable file uploading', 'Settings page', 'bp-better-messages' ); ?>
                                            <p style="font-size: 10px;"><?php _ex( 'Enable file uploading Ultimate Member group messages', 'Settings page', 'bp-better-messages' ); ?></p>
                                        </th>
                                    </tr>
                                ...
                                <table class="widefat bm-switcher-table">
                                    ...
                                    <tr>
                                        <th colspan="2" style="padding-left: 20px;">
                                            <?php _ex( 'BuddyPress Profile Slug', 'Settings page','bp-better-messages' ); ?>
