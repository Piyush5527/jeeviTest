...
if ( !class_exists( 'Better_Messages' ) && !function_exists( 'bpbm_fs' ) ) {
    class Better_Messages
    {
        ...
        public  $chats ;
        /** @var Better_Messages_Notifications $email */
        public  $email ;
        ...
        public function setup_classes()
        {
            ...
            if ( function_exists( 'Better_Messages_Tab' ) ) {
                $this->tab = Better_Messages_Tab();
            }
            if ( $this->settings['replaceStandardEmail'] === '1' ) {
                $this->email = Better_Messages_Notifications();
            }
            ...
            if ( file_exists( $this->path . 'addons/calls-group.php' ) && Better_Messages()->functions->can_use_premium_code_premium_only() ) {
                require_once 'addons/calls-group.php';
            }
            ...
            if ( function_exists( 'Better_Messages_Calls_Group' ) ) {
                if ( $this->settings['groupCallsGroups'] === '1' || $this->settings['groupCallsThreads'] === '1' || $this->settings['groupCallsChats'] === '1' ) {
        ...
        public function get_script_variables()
        {
            ...
            $script_variables = array(
                'hash'                => md5( serialize( $this->settings ) . $this->version ),
                ...
                'loginUrl'            => apply_filters( 'better_messages_login_url', wp_login_url() ),
