...
if ( !class_exists( 'Better_Messages_Notifications' ) ):
    ...
    class Better_Messages_Notifications
    {
        ...
        {
            if( has_action('bb_digest_email_notifications_hook', 'bb_digest_message_email_notifications') ){
                remove_action( 'bb_digest_email_notifications_hook', 'bb_digest_message_email_notifications' );
            }
