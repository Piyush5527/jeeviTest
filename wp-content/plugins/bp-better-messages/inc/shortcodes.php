...
class Better_Messages_Shortcodes
{
    ...
    public function bp_better_messages_pm_button( $args ){
        ...
        if( $user_id === get_current_user_id() ) $class .= ' bm-self-button';
        ...
        $base_url = Better_Messages()->functions->get_link(get_current_user_id());
    ...
    public function bp_better_messages_mini_chat_button( $args ){
        ...
        return '<a href="' . esc_url($link) .  '" class="' . esc_attr($class) . '" data-user-id="' . $user_id . '" '. $attributes. '>' . esc_attr($text) . '</a>';
    }
    ...
    public function bp_better_messages_url(){
        ...
        return Better_Messages()->functions->get_link( get_current_user_id() );
    }
    ...
    function unread_counter_shortcode( $args ) {
        ...
        if( Better_Messages()->settings['mechanism'] !== 'websocket'){
            $unread = Better_Messages()->functions->get_total_threads_for_user( get_current_user_id(), 'unread' );
